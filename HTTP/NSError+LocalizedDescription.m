...
//  bcgames
//
//  Created by xyz on 2018/11/13.
//  Copyright © 2018 com.kubo. All rights reserved.
//
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        [self swizzleMethod:@selector(localizedDescription) with:@selector(localizedDescription4ErrorDomain)];
    });
}
